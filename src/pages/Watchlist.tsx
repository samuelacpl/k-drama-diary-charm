...
export default function Watchlist() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container max-w-3xl py-6 space-y-6">
                  ...
                  results.map((r) => (
                    ...
                    >
                      <img
                        ...
                        alt=""
                        className="w-10 h-14 object-cover rounded-lg border border-border bg-muted"
                      />
        ...
        {dramas.length > 0 ? (
          <div className="space-y-3">
            {dramas.map((drama) => (
              ...
              >
                ...
                <button
                  onClick={(e) => handleRemove(e, drama)}
          ...
          <div className="text-center py-16 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Search for a K-Drama above to add it 🌸
            </p>
          </div>
        )}
      </main>
      ...
      <Dialog
        open={!!selectedDrama}
        onOpenChange={(open) => !open && setSelectedDrama(null)}
      >
        <DialogContent className="max-w-md max-h-[85vh] overflow-y-auto p-0 rounded-2xl border-border">
          {selectedDrama && (
            <div className="space-y-4 p-6">
              ...
              <p className="text-xs text-muted-foreground">
                {selectedDrama.totalEpisodes} episodes
              </p>
                    ...
                    {selectedDrama.cast.slice(0, 8).map((actor) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-[10px] font-semibold text-foreground mt-1 line-clamp-1">
                            {actor.name}
                          </p>
